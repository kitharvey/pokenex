  ...
  return (
    <div className="landing-page">
      <div className="left">
        ...
        <p className="signin">
          Record your score and collect your favorite pokemons by{" "}
          <span>
            {" "}
            <button type="button" onClick={() => signIn("github")}>
              signing in with <FaGithub />
            </button>
          </span>{" "}
        </p>

        <div className="button-wrapper">
          <button type="button" className="black-button" onClick={() => router.push("/explore")}>
            Explore
          </button>
          <button type="button" className="black-button" onClick={() => router.push("/play")}>
            Play
          </button>
        </div>
      </div>
